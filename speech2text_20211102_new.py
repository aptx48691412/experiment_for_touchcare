...
def listen_print_loop(responses,all_start,v,c):
    lap_dict=dict()
    lap_dict_kks=dict()
    ...
    with open('./csv/speech2txt_{}.csv'.format(v[c]),'w',newline='') as f:
        writer=csv.writer(f)
...
def main(all_start_,v,c):
    ...
    with MicrophoneStream(RATE, CHUNK) as stream:
        ...
        listen_print_loop(responses,all_start_,v,c)
